...
### 5.1.0
  - Overview
    - Changes to Analytics, Auth & Database.
  - Changes
    ...
    - Analytics: Added `GetAppInstanceIdAsync()` which allows developers to
...
### 5.0.0
  ...
  - Changes
    ...
    - Realtime Database (iOS / Android): Now implemented as wrapper around
      Firebase iOS and Android SDKs, to increase reliability and performance.
